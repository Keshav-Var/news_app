...
class FetchByCatagory implements UseCase<List<NewsEntity>, CategoryParams> {
  final NewsRepository newsRepository;
  FetchByCatagory({required this.newsRepository});

  @override
  Future<Either<Failure, List<NewsEntity>>> call(CategoryParams param) async {
    final result = await newsRepository.fetchByCatagory(param.category);
